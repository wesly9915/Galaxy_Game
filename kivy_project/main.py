...
class MainWidget(RelativeLayout):
    ...
    perspectiive_point_x = NumericProperty(0)
    perspectiive_point_y = NumericProperty(0)

    V_NB_LINES = 8
    V_LINES_SPACING = .2  # Percantage of screen width
    vertical_lines = []

    H_NB_LINES = 15
    H_LINES_SPACING = .1  # Percantage of screen width
    horizontal_lines = []
    ...
    def init_audio(self):
        ...
        self.sound_restart = SoundLoader.load("audio/begin.wav")
    ...
    def on_perspectiive_point_x(self, widget, value):
        # print(f"PX: {str(value)}")
        pass

    def on_perspectiive_point_y(self, widget, value):
    ...
    def get_line_x_from_index(self, index):
        central_line_x = self.perspectiive_point_x
    ...
    def update_tiles(self):
        for i in range(0, self.NB_TILES):
            ...
            # bottom left is first point, totate clockwise
